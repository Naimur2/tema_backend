                        ...
                        <form action="/events" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-user" id="starting_date" name="starting_date" placeholder="" required>
                                    @error('starting_date')
                                    <div class="text-danger is-invalid">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-user" id="ending_date" name="ending_date" placeholder="" required>
                                    @error('ending_date')
                                    <div class="text-danger is-invalid">
